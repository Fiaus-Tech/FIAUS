...
export const initialProjects = [
  ...
  },
  {
    ...
    fullDescription: 'Current Ache BD serves as an essential national utility monitor, tracking load-shedding schedules, active grid status across all districts, and historical power disruption trends with high-throughput caching.',
    fullDescriptionAr: 'منصة وطنية خدمية لمتابعة حالة شبكة الكهرباء القومية وجداول تخفيف الأحمال عبر جميع المناطق مع إحصاءات تاريخية دقيقة.',
